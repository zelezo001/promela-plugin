...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.jps.model.VerificationRunProperties
...
/**
 * Build target for building a verification model.
 * @param runConfiguration the verification run configuration
 * @param myFile the Promela file to build
 * @param module the JPS module
 */
class PromelaVerificationBuildTarget(
    val runConfiguration: JpsTypedRunConfiguration<VerificationRunProperties?>,
    val myFile: File,
    val module: JpsModule,
) : BuildTarget<PromelaRootDescriptor?>(
    PromelaVerificationBuildTargetType.INSTANCE
) {

    // implement quality otherwise incremental builds do not work

    override fun hashCode(): Int {
        var result = runConfiguration.hashCode()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as PromelaVerificationBuildTarget
    ...
    override fun getId(): String = "promela-verification://" + runConfiguration.name
    ...
    override fun getPresentableName(): String = "Promela verification ${runConfiguration.name} of model ${myFile.path}"
}