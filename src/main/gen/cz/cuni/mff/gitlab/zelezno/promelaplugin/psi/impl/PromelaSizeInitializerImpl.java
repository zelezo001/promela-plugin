...
public class PromelaSizeInitializerImpl extends ASTWrapperPsiElement implements PromelaSizeInitializer {

  public PromelaSizeInitializerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitSizeInitializer(this);
  }
