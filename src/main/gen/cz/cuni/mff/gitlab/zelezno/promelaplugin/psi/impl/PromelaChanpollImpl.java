...
public class PromelaChanpollImpl extends ASTWrapperPsiElement implements PromelaChanpoll {

  public PromelaChanpollImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitChanpoll(this);
  }
