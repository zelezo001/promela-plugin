...
public class PromelaProctypeHeaderImpl extends ASTWrapperPsiElement implements PromelaProctypeHeader {

  public PromelaProctypeHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitProctypeHeader(this);
  }
  ...
  @Override
  @Nullable
  public PromelaActive getActive() {
    return findChildByClass(PromelaActive.class);
  }

  @Override
  @Nullable
  public PromelaDProctype getDProctype() {
    return findChildByClass(PromelaDProctype.class);
  }
