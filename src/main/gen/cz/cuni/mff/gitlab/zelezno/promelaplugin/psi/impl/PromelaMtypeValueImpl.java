...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.MTypeValueImplMixin;
...
public class PromelaMtypeValueImpl extends MTypeValueImplMixin implements PromelaMtypeValue {

  public PromelaMtypeValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitMtypeValue(this);
  }
