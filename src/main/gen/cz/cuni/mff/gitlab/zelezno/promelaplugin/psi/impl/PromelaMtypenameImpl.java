...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.MtypenameImplMixin;
...
public class PromelaMtypenameImpl extends MtypenameImplMixin implements PromelaMtypename {

  public PromelaMtypenameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitMtypename(this);
  }
