...
public class PromelaTernaryAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaTernaryAnyExpression {

  public PromelaTernaryAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitTernaryAnyExpression(this);
  }
