...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.InlineArgImplMixin;
...
public class PromelaInlineArgImpl extends InlineArgImplMixin implements PromelaInlineArg {

  public PromelaInlineArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitInlineArg(this);
  }
