...
public class PromelaConstImpl extends ASTWrapperPsiElement implements PromelaConst {

  public PromelaConstImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PromelaNumberRule getNumberRule() {
    return findChildByClass(PromelaNumberRule.class);
  }
