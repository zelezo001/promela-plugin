...
public class PromelaReceiveImpl extends ASTWrapperPsiElement implements PromelaReceive {

  public PromelaReceiveImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PromelaRecvArgs getRecvArgs() {
    return findNotNullChildByClass(PromelaRecvArgs.class);
  }

  @Override
  @NotNull
  public PromelaVarref getVarref() {
    return findNotNullChildByClass(PromelaVarref.class);
  }
