...
public class PromelaChInitImpl extends ASTWrapperPsiElement implements PromelaChInit {

  public PromelaChInitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitChInit(this);
  }
  ...
  @Override
  @Nullable
  public PromelaChInitTypes getChInitTypes() {
    return findChildByClass(PromelaChInitTypes.class);
  }

  @Override
  @NotNull
  public PromelaConstExpression getConstExpression() {
    return findNotNullChildByClass(PromelaConstExpression.class);
  }
