...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.MultiplicationConstExpressionImplMixin;
...
public class PromelaMultiplicationConstExpressionImpl extends MultiplicationConstExpressionImplMixin implements PromelaMultiplicationConstExpression {

  public PromelaMultiplicationConstExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitMultiplicationConstExpression(this);
  }
