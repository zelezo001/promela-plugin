...
public class PromelaSendImpl extends ASTWrapperPsiElement implements PromelaSend {

  public PromelaSendImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PromelaSendArgs getSendArgs() {
    return findNotNullChildByClass(PromelaSendArgs.class);
  }
