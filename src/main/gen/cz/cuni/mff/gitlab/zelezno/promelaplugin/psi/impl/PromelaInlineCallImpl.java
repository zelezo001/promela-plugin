...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.InlineCallImplMixin;
...
public class PromelaInlineCallImpl extends InlineCallImplMixin implements PromelaInlineCall {

  public PromelaInlineCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitInlineCall(this);
  }
  ...
  @Override
  @Nullable
  public PromelaArgLst getArgLst() {
    return findChildByClass(PromelaArgLst.class);
  }
