...
public class PromelaPidReferAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaPidReferAnyExpression {

  public PromelaPidReferAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitPidReferAnyExpression(this);
  }
