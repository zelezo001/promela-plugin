...
public class PromelaChanpollBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaChanpollBaseExpression {

  public PromelaChanpollBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitChanpollBaseExpression(this);
  }
  ...
  @Override
  @NotNull
  public PromelaChanpoll getChanpoll() {
    return findNotNullChildByClass(PromelaChanpoll.class);
  }
