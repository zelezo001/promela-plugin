...
public class PromelaActivePriorityImpl extends ASTWrapperPsiElement implements PromelaActivePriority {

  public PromelaActivePriorityImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitActivePriority(this);
  }
  ...
  public PromelaConstExpression getConstExpression() {
    return findChildByClass(PromelaConstExpression.class);
  }
