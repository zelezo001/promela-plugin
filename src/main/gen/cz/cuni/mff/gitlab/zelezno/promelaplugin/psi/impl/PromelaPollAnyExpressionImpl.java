...
public class PromelaPollAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaPollAnyExpression {

  public PromelaPollAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitPollAnyExpression(this);
  }
