...
public class PromelaRecvArgImpl extends ASTWrapperPsiElement implements PromelaRecvArg {

  public PromelaRecvArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitRecvArg(this);
  }
