...
public class PromelaConstAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaConstAnyExpression {

  public PromelaConstAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitConstAnyExpression(this);
  }
