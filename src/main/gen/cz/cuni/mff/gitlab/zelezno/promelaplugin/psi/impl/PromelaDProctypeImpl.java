...
public class PromelaDProctypeImpl extends ASTWrapperPsiElement implements PromelaDProctype {

  public PromelaDProctypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitDProctype(this);
  }
