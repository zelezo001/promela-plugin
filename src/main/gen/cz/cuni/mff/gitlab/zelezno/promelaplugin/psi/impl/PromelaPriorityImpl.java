...
public class PromelaPriorityImpl extends ASTWrapperPsiElement implements PromelaPriority {

  public PromelaPriorityImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitPriority(this);
  }
