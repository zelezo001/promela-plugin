...
public class PromelaUnaryBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaUnaryBaseExpression {

  public PromelaUnaryBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitUnaryBaseExpression(this);
  }
