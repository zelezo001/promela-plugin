...
public class PromelaArrayInitImpl extends ASTWrapperPsiElement implements PromelaArrayInit {

  public PromelaArrayInitImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PromelaConst> getConstList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PromelaConst.class);
  }
