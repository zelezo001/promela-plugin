...
public class PromelaEnabledBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaEnabledBaseExpression {

  public PromelaEnabledBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitEnabledBaseExpression(this);
  }
