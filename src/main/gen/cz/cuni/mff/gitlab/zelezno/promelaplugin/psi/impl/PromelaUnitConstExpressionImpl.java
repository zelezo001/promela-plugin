...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.UnitConstExpressionImplMixin;
...
public class PromelaUnitConstExpressionImpl extends UnitConstExpressionImplMixin implements PromelaUnitConstExpression {

  public PromelaUnitConstExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitUnitConstExpression(this);
  }
