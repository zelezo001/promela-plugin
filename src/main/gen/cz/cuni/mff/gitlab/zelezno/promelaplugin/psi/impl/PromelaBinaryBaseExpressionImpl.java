...
public class PromelaBinaryBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaBinaryBaseExpression {

  public PromelaBinaryBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitBinaryBaseExpression(this);
  }
  ...
  @Override
  @NotNull
  public List<PromelaBaseExpression> getBaseExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PromelaBaseExpression.class);
  }
