...
public class PromelaIdentifierImpl extends ASTWrapperPsiElement implements PromelaIdentifier {

  public PromelaIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public @Nullable String getName() {
    return PromelaPsiImplUtil.getName(this);
  }
