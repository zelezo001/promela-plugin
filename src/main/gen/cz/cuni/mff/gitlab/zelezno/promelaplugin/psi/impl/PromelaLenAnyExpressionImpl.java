...
public class PromelaLenAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaLenAnyExpression {

  public PromelaLenAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitLenAnyExpression(this);
  }
