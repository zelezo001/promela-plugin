...
public class PromelaTernaryBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaTernaryBaseExpression {

  public PromelaTernaryBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitTernaryBaseExpression(this);
  }
  ...
  public PromelaParenthesis getParenthesis() {
    return findNotNullChildByClass(PromelaParenthesis.class);
  }
