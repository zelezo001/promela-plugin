...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.TraceImplMixin;
...
public class PromelaTraceImpl extends TraceImplMixin implements PromelaTrace {

  public PromelaTraceImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PromelaNoTrace getNoTrace() {
    return findChildByClass(PromelaNoTrace.class);
  }
