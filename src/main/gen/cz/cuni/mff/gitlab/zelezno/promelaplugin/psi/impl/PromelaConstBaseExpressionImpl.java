...
public class PromelaConstBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaConstBaseExpression {

  public PromelaConstBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitConstBaseExpression(this);
  }
  ...
  public PromelaConst getConst() {
    return findNotNullChildByClass(PromelaConst.class);
  }
