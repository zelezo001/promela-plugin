...
public class PromelaRecvArgsImpl extends ASTWrapperPsiElement implements PromelaRecvArgs {

  public PromelaRecvArgsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitRecvArgs(this);
  }
  ...
  @Override
  @NotNull
  public List<PromelaRecvArg> getRecvArgList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PromelaRecvArg.class);
  }
