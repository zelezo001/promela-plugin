...
public class PromelaNoTraceImpl extends ASTWrapperPsiElement implements PromelaNoTrace {

  public PromelaNoTraceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitNoTrace(this);
  }
