...
public class PromelaPcValueBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaPcValueBaseExpression {

  public PromelaPcValueBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitPcValueBaseExpression(this);
  }
