...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.ConstExpressionImplMixin;
...
public abstract class PromelaConstExpressionImpl extends ConstExpressionImplMixin implements PromelaConstExpression {

  public PromelaConstExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
