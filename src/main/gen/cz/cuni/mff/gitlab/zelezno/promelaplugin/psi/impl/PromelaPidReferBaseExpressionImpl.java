...
public class PromelaPidReferBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaPidReferBaseExpression {

  public PromelaPidReferBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitPidReferBaseExpression(this);
  }
  ...
  @Override
  @NotNull
  public List<PromelaVar> getVarList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PromelaVar.class);
  }
