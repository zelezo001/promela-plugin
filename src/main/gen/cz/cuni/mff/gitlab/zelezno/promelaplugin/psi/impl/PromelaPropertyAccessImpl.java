...
public class PromelaPropertyAccessImpl extends ASTWrapperPsiElement implements PromelaPropertyAccess {

  public PromelaPropertyAccessImpl(@NotNull ASTNode node) {
    super(node);
  }
