...
public class PromelaPollBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaPollBaseExpression {

  public PromelaPollBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitPollBaseExpression(this);
  }
  ...
  @Override
  @NotNull
  public PromelaPoll getPoll() {
    return findNotNullChildByClass(PromelaPoll.class);
  }
