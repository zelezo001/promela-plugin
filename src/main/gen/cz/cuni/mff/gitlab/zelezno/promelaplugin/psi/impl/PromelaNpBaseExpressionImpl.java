...
public class PromelaNpBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaNpBaseExpression {

  public PromelaNpBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitNpBaseExpression(this);
  }
