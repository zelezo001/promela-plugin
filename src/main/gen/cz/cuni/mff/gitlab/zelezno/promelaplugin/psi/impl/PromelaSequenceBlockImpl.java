...
public class PromelaSequenceBlockImpl extends ASTWrapperPsiElement implements PromelaSequenceBlock {

  public PromelaSequenceBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitSequenceBlock(this);
  }
  ...
  @Override
  @Nullable
  public PromelaSequence getSequence() {
    return findChildByClass(PromelaSequence.class);
  }
