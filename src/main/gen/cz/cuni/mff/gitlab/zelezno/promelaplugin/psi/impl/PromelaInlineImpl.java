...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.InlineImplMixin;
...
public class PromelaInlineImpl extends InlineImplMixin implements PromelaInline {

  public PromelaInlineImpl(@NotNull ASTNode node) {
    super(node);
  }
