...
public class PromelaBinaryAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaBinaryAnyExpression {

  public PromelaBinaryAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitBinaryAnyExpression(this);
  }
