...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.LtlImplMixin;
...
public class PromelaLtlImpl extends LtlImplMixin implements PromelaLtl {

  public PromelaLtlImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitLtl(this);
  }
  ...
  @Override
  @Nullable
  public PromelaLtlBody getLtlBody() {
    return findChildByClass(PromelaLtlBody.class);
  }
