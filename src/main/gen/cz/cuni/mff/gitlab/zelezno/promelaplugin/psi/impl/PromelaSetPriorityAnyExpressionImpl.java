...
public class PromelaSetPriorityAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaSetPriorityAnyExpression {

  public PromelaSetPriorityAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitSetPriorityAnyExpression(this);
  }
