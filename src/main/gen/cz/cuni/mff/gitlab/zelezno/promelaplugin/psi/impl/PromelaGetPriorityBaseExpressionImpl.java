...
public class PromelaGetPriorityBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaGetPriorityBaseExpression {

  public PromelaGetPriorityBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitGetPriorityBaseExpression(this);
  }
