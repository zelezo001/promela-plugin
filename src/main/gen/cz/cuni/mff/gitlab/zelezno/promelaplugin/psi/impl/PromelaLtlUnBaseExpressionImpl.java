...
public class PromelaLtlUnBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaLtlUnBaseExpression {

  public PromelaLtlUnBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitLtlUnBaseExpression(this);
  }
