...
public class PromelaWrapAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaWrapAnyExpression {

  public PromelaWrapAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitWrapAnyExpression(this);
  }
