...
public class PromelaAtomicStmntImpl extends ASTWrapperPsiElement implements PromelaAtomicStmnt {

  public PromelaAtomicStmntImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitAtomicStmnt(this);
  }
