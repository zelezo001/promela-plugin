...
public class PromelaRunBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaRunBaseExpression {

  public PromelaRunBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitRunBaseExpression(this);
  }
  ...
  @Override
  @NotNull
  public PromelaRun getRun() {
    return findNotNullChildByClass(PromelaRun.class);
  }
