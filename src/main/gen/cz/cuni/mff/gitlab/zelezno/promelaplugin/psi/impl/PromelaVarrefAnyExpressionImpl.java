...
public class PromelaVarrefAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaVarrefAnyExpression {

  public PromelaVarrefAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitVarrefAnyExpression(this);
  }
