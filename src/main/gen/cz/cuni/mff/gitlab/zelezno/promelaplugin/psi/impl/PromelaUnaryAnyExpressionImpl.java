...
public class PromelaUnaryAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaUnaryAnyExpression {

  public PromelaUnaryAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitUnaryAnyExpression(this);
  }
