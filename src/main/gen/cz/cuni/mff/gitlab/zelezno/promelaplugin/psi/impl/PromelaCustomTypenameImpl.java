...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.CustomTypenameImplMixin;
...
public class PromelaCustomTypenameImpl extends CustomTypenameImplMixin implements PromelaCustomTypename {

  public PromelaCustomTypenameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitCustomTypename(this);
  }
