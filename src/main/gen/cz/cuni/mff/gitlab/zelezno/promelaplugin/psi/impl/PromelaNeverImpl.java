...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.NeverImplMixin;
...
public class PromelaNeverImpl extends NeverImplMixin implements PromelaNever {

  public PromelaNeverImpl(@NotNull ASTNode node) {
    super(node);
  }
