...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.PromelaNumberRuleImplMixin;
...
public class PromelaNumberRuleImpl extends PromelaNumberRuleImplMixin implements PromelaNumberRule {

  public PromelaNumberRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitNumberRule(this);
  }
