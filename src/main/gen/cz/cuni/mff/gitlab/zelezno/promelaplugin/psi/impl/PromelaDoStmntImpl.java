...
public class PromelaDoStmntImpl extends ASTWrapperPsiElement implements PromelaDoStmnt {

  public PromelaDoStmntImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitDoStmnt(this);
  }
  ...
  @Override
  @NotNull
  public List<PromelaOption> getOptionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PromelaOption.class);
  }
