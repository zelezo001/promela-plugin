...
public abstract class PromelaAnyExpressionImpl extends ASTWrapperPsiElement implements PromelaAnyExpression {

  public PromelaAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
