...
public class PromelaNpAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaNpAnyExpression {

  public PromelaNpAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitNpAnyExpression(this);
  }
