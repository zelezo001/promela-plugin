...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.VarImplMixin;
...
public class PromelaVarImpl extends VarImplMixin implements PromelaVar {

  public PromelaVarImpl(@NotNull ASTNode node) {
    super(node);
  }
