...
public class PromelaPcValueAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaPcValueAnyExpression {

  public PromelaPcValueAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitPcValueAnyExpression(this);
  }
