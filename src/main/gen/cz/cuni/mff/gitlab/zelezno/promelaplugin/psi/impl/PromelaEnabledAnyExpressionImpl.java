...
public class PromelaEnabledAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaEnabledAnyExpression {

  public PromelaEnabledAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitEnabledAnyExpression(this);
  }
