...
public class PromelaVisibleImpl extends ASTWrapperPsiElement implements PromelaVisible {

  public PromelaVisibleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitVisible(this);
  }
