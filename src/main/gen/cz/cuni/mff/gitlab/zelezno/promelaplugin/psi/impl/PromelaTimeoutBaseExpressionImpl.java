...
public class PromelaTimeoutBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaTimeoutBaseExpression {

  public PromelaTimeoutBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitTimeoutBaseExpression(this);
  }
