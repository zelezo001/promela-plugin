...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.UTypeImplMixin;
...
public class PromelaUtypeImpl extends UTypeImplMixin implements PromelaUtype {

  public PromelaUtypeImpl(@NotNull ASTNode node) {
    super(node);
  }
