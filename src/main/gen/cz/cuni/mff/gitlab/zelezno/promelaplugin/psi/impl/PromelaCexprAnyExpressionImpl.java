...
public class PromelaCexprAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaCexprAnyExpression {

  public PromelaCexprAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitCexprAnyExpression(this);
  }
