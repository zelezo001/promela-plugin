...
public class PromelaSetPriorityBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaSetPriorityBaseExpression {

  public PromelaSetPriorityBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitSetPriorityBaseExpression(this);
  }
