...
public class PromelaWrapBaseExpressionImpl extends PromelaBaseExpressionImpl implements PromelaWrapBaseExpression {

  public PromelaWrapBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitWrapBaseExpression(this);
  }
