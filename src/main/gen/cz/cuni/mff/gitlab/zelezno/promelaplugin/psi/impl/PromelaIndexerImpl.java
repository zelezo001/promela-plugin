...
public class PromelaIndexerImpl extends ASTWrapperPsiElement implements PromelaIndexer {

  public PromelaIndexerImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PromelaAnyExpression getAnyExpression() {
    return findNotNullChildByClass(PromelaAnyExpression.class);
  }
