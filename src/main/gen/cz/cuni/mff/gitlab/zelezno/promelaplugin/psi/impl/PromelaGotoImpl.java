...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.language.psi.impl.GotoImplMixin;
...
public class PromelaGotoImpl extends GotoImplMixin implements PromelaGoto {

  public PromelaGotoImpl(@NotNull ASTNode node) {
    super(node);
  }
