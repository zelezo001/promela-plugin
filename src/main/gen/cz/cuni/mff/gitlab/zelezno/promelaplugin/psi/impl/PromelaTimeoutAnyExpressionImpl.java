...
public class PromelaTimeoutAnyExpressionImpl extends PromelaAnyExpressionImpl implements PromelaTimeoutAnyExpression {

  public PromelaTimeoutAnyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitTimeoutAnyExpression(this);
  }
