...
public abstract class PromelaBaseExpressionImpl extends ASTWrapperPsiElement implements PromelaBaseExpression {

  public PromelaBaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
