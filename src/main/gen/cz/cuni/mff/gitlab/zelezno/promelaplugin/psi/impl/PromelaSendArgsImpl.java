...
public class PromelaSendArgsImpl extends ASTWrapperPsiElement implements PromelaSendArgs {

  public PromelaSendArgsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitSendArgs(this);
  }
