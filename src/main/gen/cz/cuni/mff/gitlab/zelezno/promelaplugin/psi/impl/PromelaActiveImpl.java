...
public class PromelaActiveImpl extends ASTWrapperPsiElement implements PromelaActive {

  public PromelaActiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PromelaVisitor visitor) {
    visitor.visitActive(this);
  }
  ...
  @Override
  @Nullable
  public PromelaActivePriority getActivePriority() {
    return findChildByClass(PromelaActivePriority.class);
  }
