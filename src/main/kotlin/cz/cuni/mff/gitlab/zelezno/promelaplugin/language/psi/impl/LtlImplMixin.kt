...
import cz.cuni.mff.gitlab.zelezno.promelaplugin.psi.PromelaLtl

/**
 * Mixin for LTL formula implementation.
 * @param node the AST node
 */
abstract class LtlImplMixin(node: ASTNode) : ASTWrapperPsiElement(node), PromelaLtl {
    ...
    override fun getPresentation(): ItemPresentation {
        ...
        return object : ItemPresentation {
            ...
            override fun getIcon(unused: Boolean) = AllIcons.Nodes.Padlock
        }
    }
